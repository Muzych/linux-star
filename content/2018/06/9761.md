...
![](/data/attachment/album/201806/18/230348w7msk4sqz587ezbz.png)


去查看已经启用的仓库列表。转到 `System` 标签页，然后点击相应的系统。另外，你也能够看到系统勘误及可用更新。


![](/data/attachment/album/201806/18/230349nlcllo0d044emot0.png)


去管理订阅的频道。转到 `System` 标签页，然后点击有关的 `system name`，最后点击 `Manage Subscriptions`。


![](/data/attachment/album/201806/18/230349twcf49slqw1zss0c.png)
