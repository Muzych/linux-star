...
editorchoice: false
excerpt: 许多 GNU/Linux 程序的一个特点是有个易于编辑的配置文件。这些配置文件经常隐藏在用户的主目录中。
fromurl: https://fedoramagazine.org/managing-dotfiles-rcm/
id: 10466
islctt: true
largepic: /data/attachment/album/201901/22/104627m4y4jfa8z5ny6kzk.jpg
permalink: /article-10466-1.html
pic: /data/attachment/album/201901/22/104627m4y4jfa8z5ny6kzk.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lujun9972
summary: 许多 GNU/Linux 程序的一个特点是有个易于编辑的配置文件。这些配置文件经常隐藏在用户的主目录中。
tags:
- 配置文件
- 隐藏文件
thumb: false
